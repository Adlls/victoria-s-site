...
var images = 
  ...
  const workshops = [
    ...
    },
    {
      ...
      time: "16 часов",
      description: window.HTMLReactParser(`
      «Вы видите разные вещи и говорите: «Почему?» Я же выдумываю вещи, которых никогда не существовало и говорю: «Почему бы и нет?» Бердард Шоу <br/>
      «Креативность – это изобретение, экспериментирование, рост, принятие рисков, нарушение правил, совершение ошибок и веселье» Mary Lou Cook <br/>
